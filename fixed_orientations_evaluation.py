...
#################################
# non uniqueness information
#################################
# the construction of the figures proceeds by computing an SVD
#   meg_lf = U * S * V^T,
# and uses the columns of V as an orthonormal basis for defining spherical coordinates.
# Since these columns are (in the best case) only unique up to sign, this coordinate system
# is not unique. Concretely, there are 4 possible images that can be generated from the same
# MEG leadfield. Let V = (u, v, w), and let I be the image derived from the corresponding
# coordinate system. We then have the following:
#   -Using (-u, v, w) flips the image I vertically
#   -Using (u, -v, w) flips the image I vertically and horizontally
#   -Using (u, v, -w) flips the image I horizontally
#
# To exactly reproduce the figure from the paper, you can use the following sign choices.
#
# V5:
# V_transposed = [[-0.0376712 , -0.6144005 ,  0.78809448],
#                 [ 0.61715899,  0.60596762,  0.50191435],
#                 [ 0.78593617, -0.50528731, -0.35635527]]
#
# FEF:
# V_transposed = [[-0.51699244, -0.67184839,  0.53041357],
#                 [-0.47296739,  0.74067695,  0.47717869],
#                 [-0.71345685, -0.00417055, -0.70068676]]
...
if __name__ == '__main__':
  ...
  print('Please note that the image generated by this script can differ from machine to machine. This is due to the fact that the coordinate system is derived from the singular value decomposition of the MEG leadfield, where the singular vectors are only determined up to sign. Concretely, the image can be vertically and/or horizontally flipped. If you want to exactly reproduce the image from the paper, please take a look at the code of this script, where the sign choices corresponding to the figures from the paper are specified.')
